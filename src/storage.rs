    ...
    pub fn create_and_set_texture(
        ...
        match self.unused_textures.get_mut(&(width, height)) {
            ...
            Some(a)=> {
                ...
                let texture: Texture2d = Texture2d::with_mipmaps(&self.display, not_texture, texture::MipmapsOption::AutoGeneratedMipmaps).unwrap();
            ...
            _ => {
                ...
                let texture: Texture2d = Texture2d::with_mipmaps(&self.display, not_texture, texture::MipmapsOption::NoMipmap).unwrap();
                self.set_texture(k, texture);
            }
        }
    }
